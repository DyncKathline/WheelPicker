...
import com.kathline.picker.utils.ConvertUtils;
...
public abstract class ConfirmDialog<V extends View> extends BaseDialog<View> {
    ...
    protected View makeHeaderView() {
        ...
        int height = ScreenUtils.dp2px(activity, topHeight);
        ...
        int padding = ScreenUtils.dp2px(activity, topPadding);
        ...
        if (null == titleView) {
            ...
            int margin = ScreenUtils.dp2px(activity, topPadding);
